...
<div id="content" class="app-content p-3">
    ...
    <div class="card">
        ...
        <div class="card-body">
            @include('error')
            <form action="{{ route('item_cost_info.store') }}" method="post" id="itemCostForm">
                @csrf
                <div class="row">
                    ...
                    <div class="col-sm-8 col-md-6 col-lg-6 col-xl-6">
                        ...
                        <div>
                            <input type="text" class="form-control" id="additional_cost" name="additional_cost">
                    ...
                    <div class="col-sm-8 col-md-6 col-lg-6 col-xl-6">
                        ...
                        <div>
                            <input type="text" class="form-control" id="total_Purchase_cost" name="total_Purchase_cost">
