...
@section('content')
    <div id="content" class="app-content p-3">
        <div class="head-main d-flex justify-content-between my-3">
            ...
            <a href="{{ route('assignPermission.index') }}" class="btn btn-info "><i class="fas fa-list"></i>Assign Permission List</a>
        </div>
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('assignPermission.store') }}" method="post">
                    @csrf
                    <div class="mb-3 row">
                        <label for="role_id" class="col-sm-2 col-form-label">Module Name</label>
                        <div class="col-sm-10">
