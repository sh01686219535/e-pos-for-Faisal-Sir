...
<div id="content" class="app-content p-3">
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            @include('error')
            <form action="{{ route('item_info.update',$itemInfo->id) }}" method="post" id="Item-info-form" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div>
                            <select class="form-control" id="category_id" name="category_id">
                                ...
                                <option value="{{$item->id}}"{{$itemInfo->category_id == $item->id ? 'selected' : ''}}>{{$item->category_name ?? ''}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div>
                            <select class="form-control" id="brand_id" name="brand_id">
                                ...
                                <option value="{{ $brands->id}}" {{$itemInfo->brand_id == $brands->id ? 'selected' : ''}}>{{ $brands->brand_name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div>
                            <select class="form-control" id="color_id" name="color_id">
                                ...
                                <option value="{{ $colors->id}}" {{$itemInfo->color_id == $colors->id ? 'selected' : ''}}>{{ $colors->color_name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div>
                            <select class="form-control" id="size_id" name="size_id">
                                ...
                                <option value="{{ $items->id}}"{{$itemInfo->size_id == $items->id ? 'selected' : ''}}>{{ $items->size_name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div>
                            <input type="text" class="form-control" id="name" name="name" value="{{$itemInfo->name}}">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div>
                            <select class="form-control" id="supplier_id" name="supplier_id">
                                ...
                                <option value="{{ $suppliers->id}}"{{$itemInfo->supplier_id == $suppliers->id ? 'selected' : ''}}>{{ $suppliers->supplier_name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div>
                            <textarea type="text" class="form-control" id="description" name="description">{{$itemInfo->description}}</textarea>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div>
                            ...
                            @if(isset($itemInfo->image))
                            <img id="showImage1" src="{{ asset($itemInfo->image) }}" alt="" class="image-style rounded-circle my-3 img-height">
                            @else
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div>
                            ...
                            @php
                                $images = isset($itemInfo->multiple_image) ? explode(",", $itemInfo->multiple_image) : [];
                            @endphp

                            @if(!empty($images)) 
                                @foreach($images as $image)
                                    <img id="showImage1" src="{{ asset('ItemInfoMultiImg/' . $image) }}" alt="" class="image-style rounded-circle my-3 img-height">
                                @endforeach
                            @else
