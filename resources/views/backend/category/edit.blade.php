...
<div id="content" class="app-content p-3">
    ...
    <div class="card">
        ...
        <div class="card-body">
            @include('error')
            <form action="{{ route('category.update',$category->id) }}" method="post" id="brandForm">
                @csrf
                @method('PUT')
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" id="parent_id" name="parent_id">
                           ...
                           <option value="{{$item->id}}" {{$item->id == $category->parent_id ? 'selected' : ''}}>{{$item->category_name ?? ''}}</option>
